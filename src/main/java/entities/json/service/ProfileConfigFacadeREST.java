...
public class ProfileConfigFacadeREST extends AbstractFacade<ProfileConfig> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, ProfileConfig entity) {
        super.edit(entity);
    }
    ...
    public ProfileConfig find(@PathParam("id") String id) {
    ...
    @Override
    @Produces({"application/xml", "application/json"})
    public List<ProfileConfig> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<ProfileConfig> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
